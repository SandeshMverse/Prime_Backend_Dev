...
namespace PrimeMaritime_API.Services
{
    public class SRRService : ISRRService
    {
        ...
        public Response<CommonResponse> ApproveRate(List<SRR_RATES> request, int POL_FREE_DAYS, int POD_FREE_DAYS, string SLOT_OPERATOR_NAME, int RATE20, int RF20, int HAZ20)
        {
            string dbConn = _config.GetConnectionString("ConnectionString");

            DbClientFactory<SRRRepo>.Instance.ApproveRate(dbConn, request, POL_FREE_DAYS, POD_FREE_DAYS, SLOT_OPERATOR_NAME, RATE20, RF20, HAZ20);
        ...
        public Response<CommonResponse> CounterRate(List<SRR_RATES> request, int POL_FREE_DAYS, int POD_FREE_DAYS)
        {
            string dbConn = _config.GetConnectionString("ConnectionString");

            DbClientFactory<SRRRepo>.Instance.CounterRate(dbConn, request,POL_FREE_DAYS,POD_FREE_DAYS);
        ...
        public Response<List<EXC_RATE>> GetPMExcRateList()
        {
            string dbConn = _config.GetConnectionString("ConnectionString");

            Response<List<EXC_RATE>> response = new Response<List<EXC_RATE>>();
            var data = DbClientFactory<SRRRepo>.Instance.GetPMExcRateList(dbConn);
        ...
        //ADDED FOR CHECKING
        public Response<EXC_RATE> GetExcRatesPOL(string CURRENCY_CODE, string AGENT_CODE, string ORG_CODE, string PORT)
        {
            string dbConn = _config.GetConnectionString("ConnectionString");
            ...
            var data = DbClientFactory<SRRRepo>.Instance.GetExcRatesPOL(dbConn, CURRENCY_CODE, AGENT_CODE, ORG_CODE, PORT);
        ...
        public Response<EXC_RATE> GetExcRatesPOD(string CURRENCY_CODE, string AGENT_CODE, string ORG_CODE, string PORT)
        {
            string dbConn = _config.GetConnectionString("ConnectionString");
            ...
            var data = DbClientFactory<SRRRepo>.Instance.GetExcRatesPOD(dbConn, CURRENCY_CODE, AGENT_CODE, ORG_CODE, PORT);
        ...
        public Response<EXC_RATE> GetExcRatesFREIGHT(string CURRENCY_CODE, string AGENT_CODE, string ORG_CODE, string PORT)
        {
            string dbConn = _config.GetConnectionString("ConnectionString");
            ...
            var data = DbClientFactory<SRRRepo>.Instance.GetExcRatesFREIGHT(dbConn, CURRENCY_CODE, AGENT_CODE, ORG_CODE, PORT);
        ...
        public Response<string> InsertSWITCHBLAgent(string SWITCHBL_AGENT_CODE, string SRR_NO)
        {
            string dbConn = _config.GetConnectionString("ConnectionString");

            DbClientFactory<SRRRepo>.Instance.InsertSWITCHBLAgent(dbConn, SWITCHBL_AGENT_CODE, SRR_NO);
        ...
        public Response<string> RejectSwitchBL(string SRR_NO)
        {
            string dbConn = _config.GetConnectionString("ConnectionString");

            DbClientFactory<SRRRepo>.Instance.RejectSwitchBL(dbConn, SRR_NO);

            Response<string> response = new Response<string>();
            response.Succeeded = true;
            response.ResponseMessage = "Switch BL rejected Successfully.";
            response.ResponseCode = 200;
