...
namespace PrimeMaritime_API.Repository
{
    ...
    {
        public List<DROPDOWN> GetDropdownData(string connstring, string key, string port, string value, string value1, string value2)
        {
            SqlParameter[] parameters =
           {
                ...
                new SqlParameter("@VALUE1", SqlDbType.VarChar, 250) { Value = value1 },
