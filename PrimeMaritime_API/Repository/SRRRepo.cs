...
namespace PrimeMaritime_API.Repository
{
    public class SRRRepo
    {
        ...
        public string InsertSRR(string connstring, SRRRequest request)
        {
            try
            {
                SqlParameter[] parameters =
                {
                  ...
                  new SqlParameter("@AGENT_CODE", SqlDbType.VarChar, 50) { Value = request.AGENT_CODE },
                  new SqlParameter("@AGENT_NAME", SqlDbType.VarChar, 255) { Value = request.AGENT_NAME },
                  new SqlParameter("@IS_SWITCHBL", SqlDbType.VarChar, 50) { Value = request.IS_SWITCHBL },  //ADDED NEW
                  new SqlParameter("@IS_POL", SqlDbType.Bit) { Value = request.IS_POL }  //ADDED NEW
                };
                ...
                tbl2.Columns.Add(new DataColumn("TEMPERATURE", typeof(string)));
                tbl2.Columns.Add(new DataColumn("VENTILATION", typeof(string)));
                tbl2.Columns.Add(new DataColumn("HUMIDITY", typeof(string)));
        ...
        public void ApproveRate(string connstring, List<SRR_RATES> request, int POL_FREE_DAYS, int POD_FREE_DAYS, string SLOT_OPERATOR_NAME, int RATE20, int RF20, int HAZ20)
        {
            try
            {
                ...
                columns[7] = "RATE_TYPE";
                columns[8] = "AGENT_REMARKS";

                SqlHelper.UpdateSRRData<SRR_RATES>(request, "TB_SRR_RATES", connstring, columns);

                SqlParameter[] parameters =
                {
                  new SqlParameter("@OPERATION", SqlDbType.VarChar, 50) { Value = "COUNTER_SRRS" },
                  ...
                  new SqlParameter("@SLOT_OPERATOR_NAME", SqlDbType.VarChar, 100) { Value = SLOT_OPERATOR_NAME },
                  new SqlParameter("@RATE20", SqlDbType.Int) { Value = RATE20 },
                  new SqlParameter("@HAZ20", SqlDbType.Int) { Value = HAZ20 },
                  new SqlParameter("@RF20", SqlDbType.Int) { Value = RF20 },
        ...
        public List<EXC_RATE> GetPMExcRateList(string connstring)
        {
            try
            {
                SqlParameter[] parameters =
                {
                  new SqlParameter("@OPERATION", SqlDbType.VarChar, 50) { Value = "GET_PM_EXC_RATELIST" },
                };
        ...
        //ADDED NEW EXRATES 
        public EXC_RATE GetExcRatesPOL(string connstring, string CURRENCY_CODE, string AGENT_CODE, string ORG_CODE, string PORT)
        {
            try
            {
                SqlParameter[] parameters =
        ...
        public EXC_RATE GetExcRatesPOD(string connstring, string CURRENCY_CODE, string AGENT_CODE, string ORG_CODE, string PORT)
        {
            try
            {
                SqlParameter[] parameters =
        ...
        public EXC_RATE GetExcRatesFREIGHT(string connstring, string CURRENCY_CODE, string AGENT_CODE, string ORG_CODE, string PORT)
        {
            try
            {
                SqlParameter[] parameters =
        ...
        public string InsertSWITCHBLAgent(string connstring, string SWITCHBL_AGENT_CODE, string SRR_NO)
        {
            try
            {
                SqlParameter[] parameters =
                {
                  new SqlParameter("@OPERATION", SqlDbType.VarChar, 50) { Value = "INSERT_SWITCHBL_AGENT_CODE" },
                  new SqlParameter("@SWITCHBL_AGENT_CODE", SqlDbType.VarChar, 100) { Value = SWITCHBL_AGENT_CODE },
                  new SqlParameter("@SRR_NO", SqlDbType.VarChar, 100) { Value = SRR_NO },
                };
        ...
        public string RejectSwitchBL(string connstring, string SRR_NO)
        {
            try
            {
                SqlParameter[] parameters =
                {
                  new SqlParameter("@OPERATION", SqlDbType.VarChar, 50) { Value = "REJECT_SWITCHBL" },
                  new SqlParameter("@SRR_NO", SqlDbType.VarChar, 100) { Value = SRR_NO },
                };
