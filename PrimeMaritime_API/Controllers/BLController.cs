...
namespace PrimeMaritime_API.Controllers
{
    ...
    public class BLController : ControllerBase
    {
        ...
        {
            return Ok(JsonConvert.SerializeObject(_blService.GetBLALLHistory(AGENT_CODE, ORG_CODE, PORT)));
        }
        ...
        // ADDED NEW 
        [HttpGet("GetCargoBL")]
        public ActionResult<Response<CargoManifest>> getcargoBL(string AGENT_CODE, string VESSEL_NAME, string VOYAGE_NO, string BL_NO)
        {
        ...
        {
            return Ok(_blService.InsertSWITCHBL(request));
        }

        //TESTING SWTICHBL

        [HttpGet("GetSwitchBLDetails")]
        public ActionResult<Response<BL>> GetSwitchBLDetails(string BL_NO, string BOOKING_NO, string AGENT_CODE)
        {
            return Ok(JsonConvert.SerializeObject(_blService.GetSwitchBLDetails(BL_NO, BOOKING_NO, AGENT_CODE)));
        }

        [HttpPost("UpdateSwitchBL")]
        public ActionResult<Response<string>> UpdateSwitchBL(BL request)
        {
            return Ok(_blService.UpdateSwitchBL(request));
        }
