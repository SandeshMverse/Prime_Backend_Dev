...
namespace PrimeMaritime_API.IServices
{
    public interface IDepoService
    {
        ...
        Response<MNR_TARIFF> GetMNRTariff(string COMPONENT, string DAMAGE_LOCATION, string REPAIR, string LENGTH, string WIDTH, string HEIGHT, string QUANTITY, string DEPO_CODE);
