            ...
            using (SqlConnection conn = new SqlConnection(connString))
            {
                using (SqlCommand command = new SqlCommand("", conn))
                {
                    try
                    {
                        ...
                        command.CommandText = "CREATE TABLE #TmpTable(BL_NO varchar(100),CONTAINER_NO varchar(20),CONTAINER_TYPE varchar(50),SEAL_NO varchar(50),AGENT_SEAL_NO varchar(50),MARKS_NOS varchar(max),DESC_OF_GOODS varchar(max),PKG_COUNT int,PKG_DESC varchar(max),GROSS_WEIGHT numeric(18,4),NET_WEIGHT numeric(18,4),MEASUREMENT varchar(50))";
            ...
            using (SqlConnection conn = new SqlConnection(connString))
            {
                using (SqlCommand command = new SqlCommand("", conn))
                {
                    try
                    {
                        ...
                        //Creating temp table on database
                        command.CommandText = "CREATE TABLE #TmpTable(BL_NO varchar(100),BOOKING_NO varchar(100),CRO_NO varchar(100),DO_NO varchar(100),CONTAINER_NO varchar(20),CONTAINER_TYPE varchar(50),CONTAINER_SIZE varchar(50),SEAL_NO varchar(50),MARKS_NOS varchar(max),DESC_OF_GOODS varchar(max),PKG_COUNT int,PKG_DESC varchar(max),GROSS_WEIGHT numeric(18,4),NET_WEIGHT numeric(18,4),MEASUREMENT varchar(50)," +
